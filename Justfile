...
gen-bench-queries inpath outpath:
    ...
    cat {{inpath}}/q9.sql | sed 's/\tpart/\tdb1.part/g;s/lineitem/db1.lineitem/g;s/orders/db2.orders/g;s/supplier/db1.supplier/g;s/\tnation/\tdb2.nation/g' > {{outpath}}/q19.sql
    ...
    cat {{inpath}}/q11.sql | sed 's/partsupp/db1.partsupp/g;s/supplier/db1.supplier/g;s/\tnation/\tdb2.nation/g' > {{outpath}}/q11.sql
